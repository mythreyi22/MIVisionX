...
#define VX_ARRAY_ATTRIBUTE_BUFFER_OPENCL    VX_ARRAY_BUFFER_OPENCL
#define VX_ARRAY_ATTRIBUTE_BUFFER_HIP       VX_ARRAY_BUFFER_HIP
#define VX_ARRAY_ATTRIBUTE_BUFFER           VX_ARRAY_BUFFER
